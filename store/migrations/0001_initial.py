# Generated by Django 3.0.8 on 2020-07-08 05:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='store.PaymentMethod', verbose_name='PaymentMethod')),
                ('purchase_order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.PurchaseOrder', verbose_name='PurchaseOrder')),
            ],
            options={
